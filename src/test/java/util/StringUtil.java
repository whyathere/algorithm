...
public class StringUtil  {
    ...
    public static String formatStr(String msg,String... obj){
        return String.format(msg.replaceAll("","%s"),obj);
    }
     ...
     * @return
     */
    public final static String reversalStr(String srcStr){
        char[] srcChars = srcStr.toCharArray();
        char[] resultChars = new char[srcChars.length];
        int maxIndex = srcChars.length - 1;
        for (int i = maxIndex ; i >= 0 ; i --){
            resultChars[maxIndex - i] = srcChars[i];
        }
